...
def load_seed_manifest(path: str | Path = DEFAULT_SEED_PATH) -> dict[str, Any]:
    ...
    for key in expected_keys:
        ...
        if (
            ...
            raise ValueError(f"invalid seed playlist pool: {key}")
    return raw
        ...
        categories.append(
            {
                ...
                "track_count": int(safe_health.get("track_count", 0)),
                ...
                "tracks": [
                    ...
                    for track_id in manifest["playlist_pools"][playlist_key.value]
                ],
            }
        )
    return {
